...
- PR #23 playback-rate acceleration passed real-site validation: ordinary playback remained normal, accelerated capture worked, download completed, and the final video was normal. The unique-playing-video fallback successfully selected the player when exact blob matching was unavailable.
