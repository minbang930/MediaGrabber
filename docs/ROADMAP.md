...
- Test exact XHR ArrayBuffer identity against SourceBuffer append inputs for both fMP4 tracks.
- If identity association is strong, implement bounded URL ownership by response object and SourceBuffer; do not use ambiguous timing-only matching.
