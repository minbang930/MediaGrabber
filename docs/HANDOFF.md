...
1. Build/load `diag/mse-xhr-timing`, reload the page, and play for several seconds.
2. Open the MSE candidate; no download attempt is required.
3. Report the full bracketed MSE label for both buffers, especially `t20`, `t100`, `t500`, `u100`, and `m100`.
